...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PEAR-AutoLayout-iOS/PEAR_AutoLayout_iOS.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PEAR-ImageSlideViewer-iOS/PEAR_ImageSlideViewer_iOS.framework"
