...
//            {
                if let titles = nsData.object(forKey: "title") as? String
                {
                    if titles.contains("\n")
                    {
                ...
                if let body = nsData.object(forKey: "Message") as? String
                {
...
//        }
        ...
        {
            strings = (nsData.object(forKey: "Message") as? String)!
        }
        else{
    ...
    func getAllNotificationDetail() -> NSMutableArray
    {
        ...
        else if (contactDB?.open())!
        {
            ...
            while results?.next() == true
            {
                ...
                dd.setValue(results?.string(forColumn: "Financial_Year"), forKey: "Financial_Year")
                detailArray.add(dd)
            }
         }
        print(detailArray)
