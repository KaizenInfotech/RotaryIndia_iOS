...
private extension CGFloat {
    ...
    var formattedToOneDecimalPlace : String {
       ...
       // return formatter.string(from: NSNumber(value: self.native)) ?? "\(self)"
        ...
        return formatter.string(from: NSNumber(self.native))!
...
class PieChartView: UIView {
    ...
    var segmentLabelFont = UIFont.init(name: "Roboto-Regular", size: 15) {
        didSet {
    ...
    fileprivate let paragraphStyle : NSParagraphStyle = {
        var p = NSMutableParagraphStyle()
        p.alignment = .center
        return p.copy() as! NSParagraphStyle
    }()
    
    fileprivate lazy var textAttributes : [String : Any] = {
