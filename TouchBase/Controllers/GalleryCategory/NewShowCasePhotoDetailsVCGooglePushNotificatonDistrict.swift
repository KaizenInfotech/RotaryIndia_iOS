    ...
    import Alamofire
    class NewShowCasePhotoDetailsVCGooglePushNotificatonDistrict: UIViewController, UITableViewDelegate,UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    @objc  func buttonEditDownloadableDocumentClickEvent()
        {
            if(self.GetIsCategoryFromClubOrDistrict == "2"){
                ...
                objAddPhoto.checkString = checkString//Club Meetings or Service Projects
...
else
{
 ...
 if((dd.object(forKey: "TBAlbumDetailResult")! as AnyObject).object(forKey: "status") as! String == "0")
 {
   ...
   self.lblHeading.text = albumTitle
       let sharetypenew:String!=(muarrayListData.value(forKey: "shareType") as AnyObject).object(at: 0) as! String
       ...
       SVProgressHUD.dismiss()
       let sharetype3:String!=(muarrayListData.value(forKey: "shareType") as AnyObject).object(at: 0) as! String
   if(sharetype3=="1")
   {
    self.title = "District Project"
    self.btnPhotoTitle.setTitle("Project Photos", for: .normal)
    self.strWhichType="District Projects"
    self.checkString = "Service Project"
    self.pageTitle = "District Project"
   ...
   else
   {
    ...
    self.strWhichType="District Events"
    self.checkString = "Club Meetings"
    self.pageTitle = "District Event"
