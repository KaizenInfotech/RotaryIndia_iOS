...
class CelebrationViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,MFMessageComposeViewControllerDelegate,MFMailComposeViewControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        // functionFosdfdsfrAnnivNew()
        // functionForAEvdsfsdfentNewEvent()
    ...
    override func viewWillAppear(_ animated: Bool)
    {
        ...
        var getValuesnew:String!=UserDefaults.standard.string(forKey: "thisiscomingfromdetaileventdelete")
     if(getValuesnew=="yes")
       {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if(marrCalendarData.count>0)
        {
                ...
                if(objCalendarInfo.IsThisTodayDate != "0")
                {
                    if(varISTodayDateandSelectedIndexSame != indexPath.row)
                    {
                      ...
                      prototypeCell.viewCurveCircle.backgroundColor=UIColor(red: 0/255.0, green: 174/255.0, blue: 239/255.0, alpha: 1.0)
                       ...
                       // prototypeCell.viewCurveCircle.backgroundColor=UIColor.yellow
           ...
           // ////print("this is day ")
            //////print(objCalendarInfo.Day)
            
          //  ////print(muarrayDotValusdfgdsgesInCollectionNext)
            
            
            //in case next and previous set default day 1 date
            /*
            var getvalue:String = labelMonthYear.text!
            
            if(getvalue=="01" || getvalue=="1")
            {
               getvalue="1"
            }
           else if(getvalue=="02" || getvalue=="2")
            {
               getvalue="2"
            }
            else if(getvalue=="03" || getvalue=="3")
            {
                getvalue="3"
            }
            else if(getvalue=="04" || getvalue=="4")
            {
                getvalue="4"
            }
            else if(getvalue=="05" || getvalue=="5")
            {
               getvalue="5"
            }
            else if(getvalue=="06" || getvalue=="6")
            {
                getvalue="6"
            }
            else if(getvalue=="07" || getvalue=="7")
            {
                getvalue="7"
            }
            else if(getvalue=="08" || getvalue=="8")
            {
               getvalue="8"
            }
            else if(getvalue=="09" || getvalue=="9")
            {
               getvalue="9"
            }
            if(countValue==0)
  ...
  @objc  func eventBaday(_ indexPath:Int)
   ...
   @objc func buttonMainClickEvent(_ sender:UIButton)
    ...
    @objc func buttonCalendarViewWhatsAppClickEvent(_ sender:UIButton)
    {
        ...
        ////print("This is value from Rajendra jat  whatsapp !!!!!")
        ...
        // ////print(sender.tag)
        // ////print("calendar view call 11")
        //  ////print((muarrayHoldDateWiseData.object(at: sender.tag) as AnyObject))
    ...
    @objc func buttonCalendarViewCallClickEvent(_ sender:UIButton)
    {
        ...
        ////print("This is value from Rajendra jat")
    ...
    {
        ////print(sender.tag)
        ////print("calendar view sms")
        ////print((muarrayHoldDateWiseData.object(at: sender.tag) as AnyObject).value(forKey: "type"))
        ////print(sender.tag)
        
        ////print("calendar view call 22")
...
//        var getMobileNumber:String!=(muarrayHoldDateWiseData.object(at: sender.tag) as AnyObject).value(forKey: "ContactNumber")as? String
//        if(getMobileNumber.characters.count>6)
//        {
//            ////print("sms self person !!!!!!!")
//            var stringArray:[String]=[]
//            stringArray.append(getMobileNumber)
//            SMSAction(stringArray)
//        }
//        else
//        {
//            ////print("if Call click !!!!!!!")
//            ////print((muarrayHoldDateWiseData.object(at: sender.tag) as AnyObject).value(forKey: "muarrayMobileNoContact"))
//            ////print(((muarrayHoldDateWiseData.object(at: sender.tag) as AnyObject).value(forKey: "muarrayMobileNoContact")! as AnyObject).count)
//            getCountTableviewBirthAnniv = ((muarrayHoldDateWiseData.object(at: sender.tag) as AnyObject).value(forKey: "muarrayMobileNoContact")! as AnyObject).count
//            muarrayBAPopup=(muarrayHoldDateWiseData.object(at: sender.tag) as AnyObject).value(forKey: "muarrayMobileNoContact")! as! NSMutableArray
 ...
 @objc  func buttonCalendarViewEmailClickEvent(_ sender:UIButton)
    {
        ...
        else
        {
            ...
            ////print("calendar view call 33")
            
            ////print((muarrayHoldDateWiseData.object(at: sender.tag) as AnyObject))
            ////print((muarrayHoldDateWiseData.object(at: sender.tag) as AnyObject).value(forKey: "muarrayEmail"))
            ////print(((muarrayHoldDateWiseData.object(at: sender.tag) as AnyObject).value(forKey: "muarrayEmail")! as AnyObject).count)
            //Email
           // for i in 00..<((muarrayHoldDateWiseData.object(at: sender.tag) as AnyObject).value(forKey: "muarrayEmail")! as AnyObject).count
           // {
               //var
           // }
...
muarrayHoldData=muarrayBAPopup
 ...
 @objc   func buttonWhatsAppPopupClickedEvent(_ sender:UIButton)
    {
    ////print("whatsapp clicked popup clicked !!!!!!11")
        
        //DPK
        var ContactNumber:String!=""
        if(isBirthdayorAnniv=="anniv")
        {
            //let getValue:String!=muarrayBAPopup.valueForKey("Mobile").objectAtIndex(i) as! String
            ////print((muarrayBAPopup.object(at: sender.tag) as AnyObject).value(forKey: "Mobile"))
            //muarrayBAPopup=muarrayHoldData.objectAtIndex(sender.tag).valueForKey("arrayMobile")! as! NSMutableArray
            ////print(muarrayBAPopup)
            ...
            if let urlString = urlWhats.addingPercentEncoding(withAllowedCharacters: NSCharacterSet.urlQueryAllowed) {
                if let whatsappURL = URL(string: urlString) {
                    if UIApplication.shared.canOpenURL(whatsappURL) {
                       ...
                       // self.view.makeToast("WhatsApp is not installed.", duration: 3, position: CSToastPositionTop)
 ...
 @objc   func buttonSMSPopupClickedEvent(_ sender:UIButton)
   ...
   @objc func buttonEmailPopupClickedEvent(_ sender:UIButton)
    ...
    @objc func buttonWhatsApp2ClickedEvent(_ sender:UIButton)
    {
        ...
        ////print(muarrayHoldData)
        ////print("if Call click !!!!!!!")
        ////print((muarrayHoldData.object(at: sender.tag) as AnyObject).value(forKey: "arrayMobile"))
        ////print(((muarrayHoldData.object(at: sender.tag) as AnyObject).value(forKey: "arrayMobile")! as AnyObject).count)
    ...
    @objc func buttonEmailClickedEvent(_ sender:UIButton)
    {
        ...
        ////print(ContactNumber)
        //        if(ContactNumber.characters.count>4)
        //        {
        //            ////print("email self person !!!!!!!")
        //            //need to call
        //
        //            var stringArray:[String]=[]
        ...
        //        else
        //        {
        ////print("if email click !!!!!!!333")
       // ////print((muarrayHoldData.object(at: sender.tag) as AnyObject).value(forKey: "arrayEmail"))
        //////print((muarrayHoldData.object(at: sender.tag) as AnyObject).value(forKey: "arrayEmail")!.count)
        ...
        {
            //self.view.makeToast("No Email available 22", duration: 2, position: CSToastPositionCenter)
        }
    ...
    func functionForGettingCalendarMonthWiseData(_ getTodayMonthYear:String)
    {
       ...
       // loaderClass.loaderViewMethod()
        ...
        if(isCategory=="1")
        {
            ...
            ////print("OptionalOptionalOptionalOptionalOptionalOptionalOptional")
            parameterst =
                [
        ...
        ServiceManager().webserviceWithRequestMethod(HTTPMethod.post, url: completeURL, parameters: parameterst as! [AnyHashable: Any], forTask: TaskType.kTaskLogin, currentView: self.view, useAccessToken: false, completionHandler: {(response: AnyObject) -> Void in
            ...
            else
            {
                ...
                if(letGetStatus == "0" && letGetMessage == "success")
                {
                    ...
                    ////print(self.muarrayHoldDataNewEvent,self.varType)
        ...
        ServiceManager().webserviceWithRequestMethod(HTTPMethod.post, url: completeURL, parameters: parameterst as! [AnyHashable: Any], forTask: TaskType.kTaskLogin, currentView: self.view, useAccessToken: false, completionHandler: {(response: AnyObject) -> Void in
            ...
            else
            {
                ...
                if(letGetStatus == "0" && letGetMessage == "success")
                {
                    ...
                    {
                        ////print("Data found for this date !!!!!!!!!!!!")
